...
let randomValue = 10; // 'any' type allows us to assign any type of value to the variable
console.log(`Random value is ${randomValue}`);
randomValue = "Now it's a string";
console.log(`Random value is now: ${randomValue}`);
let randomValue2 = 20; // 'unknown' type is similar to 'any' but safer, we need to check the type before using it
